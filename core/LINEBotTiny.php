...
class LINEBotTiny {
    ...
    public function replyMessage($message,$type = 'reply') {
        $header = array(
        ...
        $allow = array('reply','push');
        $type = ( in_array($type,$allow) ) ? $type : 'reply';

        $response = file_get_contents('https://api.line.me/v2/bot/message/'.$type, false, $context);
